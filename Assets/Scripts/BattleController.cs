        ...
        if (playerTeamTurn)
        {
            ...
            else if (finalAttack)
            {
                ...
                if (attackType == 0)
                {
                    ...
                    {
                        if (Input.GetKeyDown(KeyCode.X)) player.GetComponent<Animator>().SetTrigger("goodChargeMelee");
                        else if (Input.GetKeyDown(KeyCode.Z)) player.GetComponent<Animator>().SetTrigger("badChargeMelee");
                    }
                }
